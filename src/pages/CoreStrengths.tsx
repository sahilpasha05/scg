            ...
            <div className="grid md:grid-cols-2 gap-8 md:gap-12">
                {DETAILED_STRENGTHS.map((strength, idx) => (
                    <motion.div 
                        ...
                        className="bg-white p-8 md:p-10 rounded-2xl shadow-sm border border-slate-100 hover:shadow-xl hover:border-brand-100 transition-all duration-300 group"
                    >
                        <div className="mb-6 inline-block p-4 bg-brand-50 rounded-2xl text-brand-600 group-hover:bg-brand-600 group-hover:text-white transition-colors duration-300">
                            {strength.icon}
                        </div>
                        <h3 className="text-2xl font-bold text-slate-900 mb-4">{strength.title}</h3>
