...
export const Team: React.FC = () => {
  return (
    <div className="pt-24">
      <SectionWrapper background="dark" className="py-6">
        <div className="text-center max-w-3xl mx-auto">
          <div className="inline-block px-4 py-1.5 rounded-full bg-brand-900/50 backdrop-blur-sm text-brand-200 text-xs font-semibold mb-3 border border-brand-500/30">
            Trusted by multiple Housing Societies
          </div>
          <h1 className="text-4xl md:text-5xl font-bold text-white mb-3">Meet the Experts</h1>
      ...
      <div className="bg-slate-50 py-16">
        <div className="container mx-auto px-4 md:px-6">
          <div className={"grid " + (TEAM.length === 4 ? 'grid-cols-1 md:grid-cols-2 lg:grid-cols-2' : 'sm:grid-cols-1 md:grid-cols-2 lg:grid-cols-3') + " gap-8 max-w-6xl mx-auto justify-items-center"}>
            {TEAM.map((member, idx) => (
              <motion.div
                key={idx}
                ...
                className="bg-white rounded-2xl overflow-hidden shadow-lg border border-slate-100 hover:shadow-xl transition-shadow duration-300 w-[360px]"
              >
                <div className="flex flex-col h-full">
                  ...
                  <div className="p-6 flex flex-col flex-grow">
                    ...
                    <p className="text-slate-600 leading-relaxed text-sm text-justify">{member.bio}</p>
                  </div>
                </div>
              </motion.div>
            ))}
      ...
      <SectionWrapper background="white" className="py-16">
        <div className="max-w-4xl mx-auto">
          <div className="text-center mb-12">
            <h2 className="text-3xl font-bold text-slate-900 mb-4">Operational Excellence</h2>
          ...
          <div className="grid md:grid-cols-2 gap-8 items-start">
            ...
            <div className="p-8 bg-slate-50 rounded-2xl border border-slate-100 flex flex-col items-start h-full">
