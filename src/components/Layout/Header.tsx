        ...
        <div className="container mx-auto px-4 pointer-events-auto">
          ...
          <div className="flex items-center justify-between h-16 sm:h-20 gap-3">
            ...
            <motion.div
              ...
              className="cursor-pointer group flex-1 max-w-[60%] sm:max-w-[65%]"
              onClick={() => handleNavClick(PageView.HOME)}
            >
              <img 
                src={logo} 
                alt="Society Ledgers Logo"
                className="w-full h-auto max-h-10 sm:max-h-12 object-contain object-left group-hover:scale-105 transition-transform duration-300 drop-shadow-lg rounded-lg"
              />
            </motion.div>
          ...
          <div className="flex items-center gap-3 xl:gap-4 pointer-events-auto w-full max-w-[95%] xl:max-w-[90%]">
            ...
            >
              <img 
                src={logo} 
                alt="Society Ledgers Logo"
                className="h-11 xl:h-13 w-auto object-contain group-hover:scale-105 transition-transform duration-300 drop-shadow-lg rounded-lg"
              />
            </motion.div>
            ...
            <motion.div 
              ...
              className="flex items-center justify-between flex-1 pl-4 xl:pl-6 pr-3 xl:pr-4 py-2 xl:py-2.5 rounded-full border border-white/20 shadow-xl shadow-slate-900/5 backdrop-blur-xl bg-white/95 transition-all duration-300"
            >
              {/* Desktop Nav */}
              <nav className="flex items-center gap-1 xl:gap-1.5 bg-slate-100/60 px-2 py-1.5 rounded-full border border-slate-200/50 flex-1">
              ...
              <button 
                ...
                className="flex items-center gap-2 bg-slate-900 hover:bg-brand-600 text-white px-4 xl:px-5 py-2 xl:py-2.5 rounded-full text-sm font-bold transition-all hover:shadow-lg hover:shadow-brand-500/25 active:scale-95 whitespace-nowrap ml-2 xl:ml-3"
              >
                Get Expert Help
              </button>
            </motion. div>
